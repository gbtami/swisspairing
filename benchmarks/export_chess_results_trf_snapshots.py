...
def _discover_round_exports(starting_list_path: Path) -> tuple[Path, ...]:
...
def main() -> None:
    ...
    round_exports = (
        ...
        else _discover_round_exports(starting_list)
    )
    ...
    event_slug = args.event_slug or _slugify(tournament.name)
    output_dir = args.output_dir.resolve() / event_slug
    ...
    for round_record in tournament.rounds:
        ...
        output_path = output_dir / f"{event_slug}_r{round_record.round_number:02d}.trf"
    ...
    manifest_path = _write_manifest(
        ...
        source_files=(starting_list, *round_exports),
